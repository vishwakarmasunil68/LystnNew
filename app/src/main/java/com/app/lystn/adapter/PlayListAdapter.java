...
public class PlayListAdapter extends RecyclerView.Adapter<PlayListAdapter.ViewHolder> {
    ...
    public PlayListAdapter(Activity activity, Fragment fragment, List<HomeContentPOJO> items) {
        this.items = items;
        ...
        holder.ll_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (activity instanceof HomeActivity) {
                    ...
                    homeActivity.playAudio(items, position, "playlist", null);
                }
            }
        });
        ...
        holder.ll_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragment instanceof PlayListFragment) {
                    PlayListFragment downloadListFragment = (PlayListFragment) fragment;
        ...
        holder.ll_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (activity instanceof HomeActivity) {
                    HomeActivity homeActivity = (HomeActivity) activity;
                    Pref.SetStringPref(activity.getApplicationContext(), StringUtils.NOTIFICAION_ALBUM_NAME, items.get(position).getConName());
                    homeActivity.playAudio(items, position, "playlist", items.get(position).getPodcastDetailPOJO());
                }
            }
        });
