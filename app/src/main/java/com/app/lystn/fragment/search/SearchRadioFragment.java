...
public class SearchRadioFragment extends FragmentController {
    ...
    public SearchRadioFragment(List<HomeContentPOJO> homeContentPOJOS) {
    ...
    public void openRadioPlayer(String conId,int position) {
