...
public class Pref {
    ...
    private static final String PrefDB = "lystn";
    private static final String PerPrefDB = "perlystn";
    ...
    public static void SaveDeviceToken(Context context, String Value) {
        SharedPreferences sp = context.getSharedPreferences("lystndevicetoken.txt", MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
